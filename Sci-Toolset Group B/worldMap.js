...
{
  let index = 0;
  //let Testing = [returnCoordsFromFlight()];
  //console.count(Testing.coordinates);
 
  let flightPath = returnCoordsFromFlight();
  flightPath.geometry.coordinates


  const testArray = [[51.958, -5.18], [51.958, -5.50],[52.000, -5.500]];
  ...
  var changeFlightPathDisplayButton = L.easyButton({
    states:[{
      ...
      onClick: function(btn, map){
        ...
        console.log(testArray.coordinates);
